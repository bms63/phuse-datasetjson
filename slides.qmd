...
format: 
  clean-revealjs:
    footer: "[bms63.github.io/phuse-datasetjson](https://bms63.github.io/phuse-datasetjson)"
    incremental: false
    css: styles.css
filters:
...
GSK, [RCSWG](https://rconsortium.github.io/submissions-wg/)

[![](images/ben_circle.png){width="400px"}](https://github.com/bms63)
:::

::: {.column width="30%"}
Sam Parmar

Pfizer, [RCSWG](https://rconsortium.github.io/submissions-wg/)

[![](images/sam_circle.png){width="400px"}](https://github.com/parmsam)
:::

::: {.column width="40%"}
Nick Masel

J&J, [RCSWG](https://rconsortium.github.io/submissions-wg/), [{datasetjson}](https://atorus-research.github.io/datasetjson/)

[![](images/nick_circle.png){width="295px"}](https://github.com/nicholas-masel)
:::
::::::
...
:::
::: {.subtitle}
Exploration of Dataset-JSON as an Alternative Transport File to Regulatory Agencies
:::
...
-   Open-source tooling and modern standards are becoming more mainstream in Pharma
...
-   A "Pilot" FDA submission using Dataset-JSON v1.1 standard (no xpts!) 
-   The R package datasetjson - a five minute crash course.
...
- The submission package was successfully delivered to the FDA via eCTD portal
in November 2025.
- A minor was revision was requested by FDA reviewers - use of `.rds` files with
a re-submission in January 2026.
- Awaiting final feedback from reviewers.
...
## Scan for Resources {.smaller}

:::::: columns
::: {.column width="25%" style="text-align: center;"}
**This Presentation**

{{< qrcode https://bms63.github.io/phuse-datasetjson >}}
:::

::: {.column width="25%" style="text-align: center;"}
**R Consortium Submissions Working Group**

{{< qrcode https://rconsortium.github.io/submissions-wg/ >}}
:::

::: {.column width="25%" style="text-align: center;"}
**datasetjson R Package**

{{< qrcode https://atorus-research.github.io/datasetjson/ >}}
:::

::: {.column width="25%" style="text-align: center;"}
**Dataset-JSON v1.1**

{{< qrcode https://cdisc-org.github.io/DataExchange-DatasetJson/doc/dataset-json1-1.html >}}
:::
::::::
...
{{< qrcode https://www.fda.gov/drugs/electronic-common-technical-document-ectd >}}
:::

::: {.column width="25%" style="text-align: center;"}
**pharmaverse adam**

{{< qrcode https://github.com/pharmaverse/pharmaverseadam >}}
:::
::::::
...
-   [Ben Straub](mailto:ben.x.straub@gsk.com), GSK – Philadelphia, United States\
-   [Sam Parmar](mailto:samir.parmar@pfizer.com), Pfizer – New York City, United States\
-   [Nick Masel](mailto:nmasel@its.jnj.com), Johnson & Johnson – Raleigh, United States
