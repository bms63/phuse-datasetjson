...
[Submissions Working Group website](https://rconsortium.github.io/submissions-wg/){target="_blank"}.
...
Now enter Pilot 5.  Building off the success of Pilot 1 and Pilot 3 we wanted to 
see if all the xpt files in the submission package could be converted to datasetjson.
The amazing [datasetjson](https://github.com/atorus-research/datasetjson) R package is available to help do a lot of the heavy lifting.
...
- HTML: [https://rpodcast.quarto.pub/pilot-5-aanalysis-data-reviewers-guide/](https://rpodcast.quarto.pub/pilot-5-aanalysis-data-reviewers-guide/)
- PDF: [https://rsubmission-draft.us-east-1.linodeobjects.com/pilot5-adrg-quarto-pdf.pdf](https://rsubmission-draft.us-east-1.linodeobjects.com/pilot5-adrg-quarto-pdf.pdf)
