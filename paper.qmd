...
**Outdated Technology:** The format was defined in the 1980s and was designed for data transfer between SAS applications on different operating systems. It is not aligned with modern data architectures or standards like Fast Healthcare Interoperability Resources (FHIR) or big-data. The FDA adopted it as [non-proprietary data format](https://www.loc.gov/preservation/digital/formats/fdd/fdd000464.shtml){target="_blank"} to submit for drug submissions.
...
In April 2025, the FDA published a [Federal Register notice](https://www.federalregister.gov/documents/2025/04/09/2025-06051/electronic-study-data-submission-data-standards-clinical-data-interchange-standards-consortium){target="_blank"} reinforcing CDISC standards for electronic study data submission, signaling regulatory openness to transport format evolution. This context makes Dataset-JSON increasingly relevant as the industry evaluates alternatives to legacy transport mechanisms while maintaining compliance with CDISC standards.
...
- Repo overview: [https://github.com/RConsortium/submissions-pilot5-datasetjson](https://github.com/RConsortium/submissions-pilot5-datasetjson){target="_blank"}
- eCTD-like package README (Quarto): [https://github.com/RConsortium/submissions-pilot5-datasetjson/blob/main/ectd_readme/README.qmd](https://github.com/RConsortium/submissions-pilot5-datasetjson/blob/main/ectd_readme/README.qmd){target="_blank"}  
- ADRG previews referenced by the repo README:
  - HTML: [https://rpodcast.quarto.pub/pilot-5-aanalysis-data-reviewers-guide/](https://rpodcast.quarto.pub/pilot-5-aanalysis-data-reviewers-guide/){target="_blank"}
  - PDF: [https://rsubmission-draft.us-east-1.linodeobjects.com/pilot5-adrg-quarto-pdf.pdf](https://rsubmission-draft.us-east-1.linodeobjects.com/pilot5-adrg-quarto-pdf.pdf){target="_blank"}
