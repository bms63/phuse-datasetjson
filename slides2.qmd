...
# 1. Motivation: Why Talk About Transport Formats?
...
# 3. XPT: Yesterday’s Solution to Yesterday’s Problem
...
# 4. Why XPT Creates Friction Today
...
# 7. Why Dataset-JSON (vs Other Modern Formats)?
...
# 8. Regulatory and Collaboration Context
...
# 9. R Consortium R Submissions Working Group
...
# 11. Pilot 5 Focus: Dataset-JSON + R-Generated ADaM
...
# 12. Pilot 5 Artifacts (What You Can See Today)
...
- ADRG previews:
  - HTML: rpodcast.quarto.pub/pilot-5-aanalysis-data-reviewers-guide/
  - PDF: rsubmission-draft.us-east-1.linodeobjects.com/pilot5-adrg-quarto-pdf.pdf
- Contents:
...
# 13. Way of Working: Reproducibility-First
...
# 14. Mini Example: ADaM Data Frame → Dataset-JSON
...
# 15. Where AI Helped (But Didn’t Replace Authors)
...
# 16. Challenges Faced: Standards & Tools
...
# 17. Challenges Faced: Technical Details
